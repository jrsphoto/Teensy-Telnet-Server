...
constexpr uint16_t kServerPort = 23;            // Telnet listens on port 23
...
EthernetServer server{kServerPort};                      // Telnet listens on port 23
